...
namespace SignalRSample.Controllers
{
    public class HomeController : Controller
    {
        ...
        private readonly IHubContext<DealthyHallowsHub> _deathlyHub;
        private readonly IHubContext<OrderHub> _orderHub;
        private readonly ApplicationDbContext _context;
        
        

        public HomeController(ILogger<HomeController> logger,IHubContext<DealthyHallowsHub> deathlyHub, ApplicationDbContext context, IHubContext<OrderHub> orderHub)
        {
            _logger = logger;
        ...
        public async Task<IActionResult> DealthyHallows(string type)
        { 
        ...
        public async Task<IActionResult> Order()
        {
            ...
            string[] iteamName = { "Food1", "Food2", "Food3", "Food4", "Food5" };
